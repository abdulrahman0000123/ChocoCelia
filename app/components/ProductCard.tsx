      ...
      >
        <div className="relative h-64 overflow-hidden bg-chocolate-50 dark:bg-chocolate-800">
          ...
          <button 
            ...
            className="absolute bottom-4 right-4 bg-white dark:bg-chocolate-800 p-3 rounded-full shadow-lg translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-chocolate-600 hover:text-white text-chocolate-600 dark:text-chocolate-200"
          >
